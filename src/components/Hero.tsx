...
export default function Hero({ mode, content }: HeroProps) {
  ...
  // ── KRANKENFAHRTEN: photo background + white gradient left + floating brand logo right ──
  if (isKranken) {
    return (
      <section
        id="hero"
      ...
      >
        ...
        {/* Light overlay: white left (text readable) → transparent right (photo visible) */}
        <div
          className="absolute inset-0"
          style={{
            background:
              'linear-gradient(to right, rgba(255,255,255,0.99) 0%, rgba(255,255,255,0.97) 30%, rgba(255,255,255,0.80) 52%, rgba(255,255,255,0.20) 75%, rgba(255,255,255,0.05) 100%)',
          }}
        />
        {/* Bottom white fade */}
        <div
        ...
        {/* Content */}
        <motion.div
          className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-14 sm:pt-36 sm:pb-20"
          style={{ y: contentY }}
        >
                ...
                return (
                  <motion.div
                    ...
                    style={{
                      ...
                      border: `1.5px solid ${isEmergency ? content.colors.accent2 : content.colors.accent}22`,
        ...
        {/* Floating brand logo card — desktop right side */}
        <motion.div
          className="absolute right-8 xl:right-16 top-1/2 -translate-y-1/2 hidden lg:block z-10"
        ...
        >
          {/* Soft green glow */}
          <div
            className="absolute inset-0 blur-3xl rounded-3xl scale-75 pointer-events-none"
            style={{ backgroundColor: 'rgba(0,148,24,0.15)' }}
          />
          <div
            className="relative rounded-3xl p-6 xl:p-8"
            style={{
              backgroundColor: 'rgba(255,255,255,0.88)',
              border: '1.5px solid rgba(0,148,24,0.18)',
              boxShadow: '0 12px 56px rgba(0,0,0,0.14), 0 2px 8px rgba(0,0,0,0.06)',
