...
export default function Hero({ mode, content }: HeroProps) {
  ...
  // ── KRANKENFAHRTEN: split-layout (logo right, text left) ──────────────────
  if (isKranken) {
    return (
      <section
        id="hero"
      ...
      >
        ...
        {/* Subtle green bottom wave */}
        <div
          className="absolute bottom-0 left-0 right-0 h-32 pointer-events-none"
          style={{
            background: 'linear-gradient(to top, rgba(0,148,24,0.06) 0%, transparent 100%)',
          }}
        />
            ...
            <div className="flex flex-col justify-center">
              ...
              <motion.div
                ...
                style={{
                  ...
                  border: '1.5px solid rgba(0,148,24,0.2)',
            ...
            >
              <div className="relative w-full max-w-[520px]">
                ...
                <div
                  ...
                  style={{ backgroundColor: 'rgba(0,148,24,0.08)' }}
                />
                <img
